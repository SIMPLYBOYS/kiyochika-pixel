...
## 十、錨與邀請（no.6、no.7 學到的）

**點名原畫裡「有」的東西是錨，點名原畫裡「沒有」的東西是邀請。** 前者要多寫，後者一個都不要寫。

| 畫 | 演出句寫了 | 結果 |
|---|---|---|
| no.6 上野公園画家写生図 | 沒寫路中央的**畫架**（主題本身），反而寫「春霞變薄」「攤子上小旗飄」 | 畫架消失、霞被清成晴空、冒出成排攤子與日之丸——整幅換掉 |
| no.7 兩國雪中 | 人物只寫泛稱「撐傘的人們」「載貨的車」，又寫「店家的布幔飄動」 | 場景保住，但前景的大白傘、背貨男子、紅輪車全被換成別的人與車；冒出寫假字的暖簾 |

寫演出句之前先放大原畫，把**畫面的主體**（這一幅為什麼叫這個名字）與**前景每一個人、每一輛車**正面寫出來；
天氣與光只寫「怎麼動」，不寫「變成什麼樣」（要霞變薄、要天放晴，都是請模型現編）。
